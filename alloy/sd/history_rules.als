...
fact{
	...
	all h1: History, hs1: HierarchicalState | let n1 = getAllNodeInSameAndDeeperLevel[hs1] | h1 in hs1.h_contains => (no h1.flowto_triggerwith[Trigger] || h1.flowto_triggerwith[Trigger] in n1)
	...
	all h1: History, r1: Region | let n1 = getAllNodeInSameAndDeeperLevel[r1] | h1 in r1.r_contains => (no h1.flowto_triggerwith[Trigger] || h1.flowto_triggerwith[Trigger] in n1)
