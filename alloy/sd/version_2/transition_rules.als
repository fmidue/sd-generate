...
fact{
        ...
        // If a composite state has a direct exit with non-empty triggers, the empty trigger can't appear in the composite state
        all c1: CompositeStates | EmptyTrigger in from.c1.label
                ...
                implies EmptyTrigger not in from.(nodesInThisAndDeeper[c1]).label
}
