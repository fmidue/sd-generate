...
fact{
	...
	all f1: ForkNode, c1: CompositeStateWithRegion, r1: Region | f1.flowto_triggerwith[Trigger] & r1.contains != none && r1 in c1.inner => #(f1.flowto_triggerwith[Trigger] & r1.contains) = 1 && #f1.flowto_triggerwith = #c1.inner
	...
	all j1: JoinNode, c1: CompositeStateWithRegion, r1: Region | r1 in c1.inner && j1 in c1.inner.contains.flowto_triggerwith[Trigger] => j1 in r1.contains.flowto_triggerwith[Trigger]
