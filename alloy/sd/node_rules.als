...
pred forkNodesGoToDistinctParalleRegions{
	...
	all f1: ForkNodes, r1: Regions, disj n1, n2: Nodes & r1.contains | 
...
pred joinNodesComeFromDistinctParalleRegions{
	all j1: JoinNodes | not lone n1: Nodes & Regions.contains | j1 in (Flows <: from).n1.to // Each join node has at least two coming arrows from regions.
	all j1: JoinNodes, r1: Regions, disj n1, n2: Nodes & r1.contains | 
