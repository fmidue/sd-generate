...
pred atMostOneStartStatesInLevels{
	all r1: Regions | lone (StartStates & r1.contains)  // In regions, there is at most one start state.
	all h1: HierarchicalStates | lone (StartStates & h1.contains) // In hierarchical states, there is at most one start state.
