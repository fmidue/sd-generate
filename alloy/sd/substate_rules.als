...
fact{
	...
	all h1: HierarchicalStates | some (h1.contains & States) // It constrains all composite states without regions
	all r1: Regions | some (r1.contains & States) // It constrains all region levels
}
