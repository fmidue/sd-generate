...
pred setStartStatesFlag{
	...
	({	
		...
		h1 = s1.flow[EmptyTriggers] 
	} || all h2: HierarchicalStates
	{	
		h2.h_contains = s1 + EndStates
		s1.flow[Triggers] = getEndStates[h2]	
...
fact{
	...
	all h1: HierarchicalStates | h1 in Nodes.flow[Triggers] => one getStartStates[h1]
