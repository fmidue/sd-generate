...
fact{
	...
	all disj s1, s2: State, h1: HierarchicalState | 
	...
	all h1: HierarchicalState, s1: State | 
		s1 in getAllNodeInSameAndDeeperLevel[h1] => disj [h1.named, s1.named]  // For all states deeper inside a composite state without regions
	all r1: Region, s1: State | 
		s1 in getAllNodeInSameAndDeeperLevel[r1] => disj [r1.named, s1.named] // For all states deeper inside a region
	all h1: HierarchicalState, r1:Region | 
		r1 in getAllRegionInSameAndDeeperLevel[h1.h_contains] => disj [h1.named, r1.named] // For all regions deeper inside a composite state without regions
	all r1, r2: Region | 
		r2 in getAllRegionInSameAndDeeperLevel[r1] => disj [r1.named, r2.named] // For all regions deeper inside a region
}
