...
fact{
  // Flows = SFlow + S_1_1Flow + S_1_2Flow + S_3Flow + Connection1 + Connection2 + Connection3 + Connection4 + Connection5 + Connection6 + Connection7 + Connection8 + Connection9 + Connection10
  // no EndNodes
  // some StartNodes
  // some ComponentNames
  // some TriggerNames
...
run {} for 0 EndNodes, 0 DeepHistoryNodes, 0 ShallowHistoryNodes, 0 ForkNodes, 0 JoinNodes, 22 ProtoFlows, exactly 14 Flows // concerning ProtoFlows, a temporary hack for manual scope setting
