...
filterConnection :: [Connection a] -> [Connection a] -> [Connection a] -- connection within same depth
filterConnection [] [] = []
...
getOrderedList :: [StateDiagram n Int [Connection Int]] -> [Int]
...
getUMLStateDiagram :: Int -> (Graph, Vertex -> (StateDiagram n Int [Connection Int], Int, [Int]),
  Int -> Maybe Vertex) -> StateDiagram n Int [Connection Int]
...
mapWithLabel :: [StateDiagram n Int [Connection Int]] -> Map.Map Int (StateDiagram n Int [Connection Int])
...
moveToFirst :: [StateDiagram n Int [Connection Int]] -> Int -> [StateDiagram n Int [Connection Int]] ->
